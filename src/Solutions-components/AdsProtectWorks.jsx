...
import icon from "../assets/solutions/tadsprotect/icon.svg";
gsap.registerPlugin(ScrollTrigger);

const AdsProtectWorks = ({ label, icon: Icon, subPara, title, desc, features = [] }) => {
  ...
  useEffect(() => {
    ...
    const cards = gsap.utils.toArray(container.querySelectorAll(".ads-stacked-card"));
  ...
  return (
    <section className="ads-works-pin" ref={containerRef}>
      <div className="ads-works-header">
         ...
         <p className="sub-para-text" style={{margin:"0"}}>{subPara}</p>
