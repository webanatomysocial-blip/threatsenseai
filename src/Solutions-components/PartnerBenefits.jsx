        ...
        <div className="benefits-cards-con">
          <div className="benefits-card-1 ben-card">
            ...
            <div className="benefits-card-body">
              ...
              <p className="para-text" style={{ color: "#000000ff" }}>
                Access training, documentation, and product resources to help
                your team succeed.
              </p>
            </div>
          </div>
          <div className="benefits-card-2 ben-card">
            ...
            <div className="benefits-card-body">
              ...
              <p className="para-text-white">
                Receive support from our technical and business teams to help
                you deliver successful deployments.
              </p>
            </div>
          </div>
          <div className="benefits-card-3 ben-card">
            ...
            <div className="benefits-card-body">
              ...
              <p className="para-text-white">
                Gain access to product demos, technical guidance, and sales
                enablement tools.
              </p>
            </div>
          </div>
          <div className="benefits-card-4 ben-card">
            ...
            <div className="benefits-card-body">
              ...
              <p className="para-text-white">
                Stay ahead of the market with early visibility into new features
                and product updates.
              </p>
            </div>
          </div>
