  ...
  const cardData = [
    {
      ...
      description:
        "Audit Trail Enforcer continuously monitors audit policies and logging configurations across SAP application and database layers. If audit logging is disabled, intentionally or accidentally, Audit Trail Enforcer automatically restores it, ensuring uninterrupted audit trail availability and compliance with MCA Rule 11(g)..",
      link: "#",
      img: bgImage,
      video: null,
    },
    ...
    },
    {
      ...
      description:
        "When compliance violations are detected, Audit Trail Enforcer automatically executes predefined actions such as user locking, escalation, or workflow initiation. This ensures policy breaches are not only identified but actively contained and addressed without manual intervention.",
      link: "#",
      img: bgImage,
      video: null,
    },
    {
      ...
      description:
        "Every audit or compliance violation is automatically logged as an incident through API-based integration with enterprise ITSM platforms. Audit Trail Enforcer also supports an optional built-in ITSM module, ensuring consistent tracking, accountability, and resolution of compliance events.",
      link: "#",
      img: bgImage,
      video: null,
    },
    {
      ...
      description:
        "Audit Trail Enforcer tracks changes consistently across SAP application and database layers, eliminating visibility gaps. This ensures all critical table, configuration, and structural changes are captured in a single, unified audit trail aligned with regulatory expectations.",
      link: "#",
      img: bgImage,
      video: null,
    },
