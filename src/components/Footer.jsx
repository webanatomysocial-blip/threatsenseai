      ...
      >
        <div className="footer-top">
          <div className="footer-left">
            ...
            <p className="para-text-white" style={{ maxWidth: "400px", color: "#ccc" }}>
            ...
            <div className="footer-links-container">
              <div className="footer-column">
                ...
                <ul className="footer-links">
                  <li>
                    <Link to="/" className="para-text-white" style={{ fontSize: "14px", color: "#999" }}>
                      Home
                    </Link>
                  </li>
                  ...
                  <li>
                    <Link to="/about" className="para-text-white" style={{ fontSize: "14px", color: "#999" }}>
                      About
                    </Link>
                  </li>
                ...
                <div className="footer-socials">
                  <span className="sub-para-text-white" style={{ display: "block", marginBottom: "10px" }}>
                    Social
                  </span>
              ...
              <div className="footer-column">
                ...
                <ul className="footer-links">
                  <li>
                    <Link to="/privacy-policy" className="para-text-white" style={{ fontSize: "14px", color: "#999" }}>
                      Privacy Policy
                    </Link>
                  </li>
      ...
      <div className="footer-bottom">
        ...
        >
          <div className="footer-logo-container">
            <img src={logoWhite} alt="ThreatSenseAI" className="footer-logo-img" />
