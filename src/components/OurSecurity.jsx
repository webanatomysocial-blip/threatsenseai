...
const securitySteps = [
  ...
  },
  {
    ...
    description:
      "Security policies must do more than alert. ThreatSenseAI enforces data protection controls dynamicallyblocking risky actions, reinstating disabled safeguards, masking sensitive data, and restricting unauthorized sharing without disrupting business operations or system performance.",
  },
  {
    id: "03",
