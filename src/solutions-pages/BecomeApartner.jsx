...
export default function BecomeAPartner() {
  ...
  const tadsCapFeatures = [
    ...
    },
    {
      id: 3,
      icon: <FiGitMerge />,
      title: "Consulting & Implementation Partners",
  ...
  const globalpartner = [
    {
      ...
      title: (
        <>
          We collaborate with organizations that <br></br> specialize in:
        </>
      ),
      items: [
    ...
    },
    {
      ...
      title: (
        <>
          ThreatSenseAI partners with organizations across multiple industries
          including:
        </>
      ),
      items: [
    ...
    <>
      <section className="tads-protect-banner-2">
        <div className="tads-banner-content">
          ...
          >
            Join the ThreatSenseAI partner ecosystem and help organizations{" "}
            <br />
            protect their most critical data across SAP and enterprise
            environments.
          </p>
          <a
            href="https://tidycal.com/threatsenseai/threatsense-ai-partner-discovery-call"
      ...
      <Cta
        ...
        description={
          <>
            Join ThreatSense AI’s global partner ecosystem and deliver advanced
            security solutions <br /> to your customers while expanding your
