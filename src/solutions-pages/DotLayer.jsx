...
const DotLayer = () => {
    const endpointFeatures = [
        { icon: <FaPrint />, title: "Entering PII/SPII into AI tools and prompts" },
        { icon: <FaFileAlt />, title: "Uploading confidential documents to cloud apps" },
        { icon: <FaUsb />, title: "Cross-platform copy-paste data leakage" },
        { icon: <FaDesktop />, title: "Data exposure through browser email and web forms" },
        { icon: <FaDesktop />, title: "Exposing data through browser-based email and forms" },
    ];
