...
export default function Mcaat() {
  const core = [
    {
      ...
      title: "Always-On\n Audit Readiness",
      description:
        "Eliminates reliance on manual checks by ensuring audit trails are always active. Even if logs are disabled during maintenance or misuse, Audit Trail Enforcer restores continuity automatically, removing one of the most common causes of audit non-compliance.",
    },
    {
      icon: <FaHistory />,
      title: "Before & After\nValue Capture",
  ...
  const Cardscontent = [
    {
      ...
      description:
        "Audit Trail Enforcer continuously monitors audit policies and logging configurations across SAP application and database layers. If audit logging is disabled - intentionally or accidentally, it automatically restores the required settings, helping ensure uninterrupted audit trail availability and continuous compliance with global regulatory requirements, including MCA Audit Trail Rule 11(g).",
      img: null,
      video: videomcaat1,
    },
    {
  ...
  return (
    <>
      <section className="mcaat-banner">
        <div className="mcaat-banner-content">
          <h1 ref={headerRef} className="big-text-head">
            Audit Trail    <br />
            {isMobile
              ? splitLetters("Enforcer for SAP")
              : splitLetters("Enforcer for SAP")}
          </h1>
          <p className="sub-para-text">
          Audit Trail Enforcer monitors, secures, and enforces audit trail integrity across SAP databases, helping ensure critical activities cannot go untracked, disabled, or altered. 
          </p>
      ...
      <SolutionCards
        label="Automated Controls Delivered by Audit Trail Enforcer"
        title="Compliance that enforces itself"
        description={
          isMobile
            ? "Audit Trail Enforcer delivers automated compliance controls that continuously protect audit trails, enforce logging policies, and respond instantly to violations, helping organizations stay aligned with global regulatory and audit requirements at all times. "
            : "Audit Trail Enforcer delivers automated compliance controls that continuously protect audit trails,enforce logging policies \n and respond instantly to violations, helping organizations stay aligned with global regulatory and audit requirements at all times."
        }
        items={Cardscontent}
        marginTop="0px"
      />
      ...
      <UseCases
        label="Use Cases"
        title={<>Always-On Audit Trail Compliance with ATE</>}
        list={useCasesList}
        image={img4}
