...
import dprm from "../assets/solutions/tads/tads-in/4.png";
    ...
    <>
      <section className="tads-banner">
        <div className="tads-banner-content">
          ...
          >
            Unified protection for SAP data across leaks, privacy, masking,
            browsers, and compliance.
            <br />
            <span style={{ fontWeight: "bold" }}>
              {" "}
              Four products. One platform. Complete SAP data protection.
            </span>
            Protect sensitive enterprise data across SAP applications, browsers,
            databases, endpoints, and AI-driven workflows with an integrated
      ...
      <section className="protection-layer-section">
        <div className="capabilities-header">
          ...
          <h2 className="head-text">
            Complete Protection Against Modern Data Leaks
          </h2>
        </div>
      ...
      <Cta
        title="Take Control of How SAP Data
